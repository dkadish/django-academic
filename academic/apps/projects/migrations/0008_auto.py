...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'projects.project': {
            ...
            'people': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'projects'", 'to': u"orm['people.Person']", 'through': u"orm['projects.Involvement']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
