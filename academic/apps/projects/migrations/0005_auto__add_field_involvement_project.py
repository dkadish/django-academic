...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Involvement.project'
        db.add_column(u'projects_involvement', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['projects.Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Involvement.project'
        db.delete_column(u'projects_involvement', 'project_id')
