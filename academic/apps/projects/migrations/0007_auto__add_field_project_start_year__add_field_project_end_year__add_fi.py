...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.start_year'
        db.add_column(u'projects_project', 'start_year',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=2000),
                      keep_default=False)

        # Adding field 'Project.end_year'
        db.add_column(u'projects_project', 'end_year',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=2000),
                      keep_default=False)

        # Adding field 'Project.presented_year'
        db.add_column(u'projects_project', 'presented_year',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=2000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.start_year'
        db.delete_column(u'projects_project', 'start_year')

        # Deleting field 'Project.end_year'
        db.delete_column(u'projects_project', 'end_year')

        # Deleting field 'Project.presented_year'
        db.delete_column(u'projects_project', 'presented_year')
    ...
    models = {
        ...
        u'projects.involvement': {
            'Meta': {'ordering': "('order',)", 'object_name': 'Involvement'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
        ...
        u'projects.project': {
            ...
            'end_year': ('django.db.models.fields.SmallIntegerField', [], {'default': '2000'}),
            ...
            'presented_year': ('django.db.models.fields.SmallIntegerField', [], {'default': '2000'}),
            ...
            'start_year': ('django.db.models.fields.SmallIntegerField', [], {'default': '2000'}),
