...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.image_caption'
        db.add_column(u'projects_project', 'image_caption',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Project.image_caption'
        db.delete_column(u'projects_project', 'image_caption')
