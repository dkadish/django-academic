...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Involvement'
        db.create_table(u'projects_involvement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'projects', ['Involvement'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Involvement'
        db.delete_table(u'projects_involvement')
